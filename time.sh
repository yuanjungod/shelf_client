...
echo "ML frame server running" >> /home/gxm/code/shelf_client/test.tex
# rm -rf *.log
fi
...
echo "image server running" >> /home/gxm/code/shelf_client/test.tex
# rm -rf *.log
fi
...
echo "client finished" >> /home/gxm/code/shelf_client/test.tex
