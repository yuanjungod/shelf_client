...
class FormatDataStub(object):
  ...
  def __init__(self, channel):
    ...
    self.DoFormat = channel.unary_unary(
        ...
        request_serializer=data__pb2.ShelfInfo.SerializeToString,
        response_deserializer=data__pb2.CMDInfo.FromString,
        )
...
def add_FormatDataServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'DoFormat': grpc.unary_unary_rpc_method_handler(
          servicer.DoFormat,
          request_deserializer=data__pb2.ShelfInfo.FromString,
          response_serializer=data__pb2.CMDInfo.SerializeToString,
      ),
  }
